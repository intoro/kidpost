...
$(window).load(function() {
    ...
    function getFormData() {
        return {
            ...
            description_2: $('#pin-form-description_2').val(),
            youtube: $('#pin-form-youtube').val(),
    ...
    function createPinForm(editPinId) {
        ...
        var modal = $('#pin-form'),
            ...
            $('#pin-form-tags'), $('#pin-form-description_2'), $('#pin-form-youtube')  ],
        ...
        if (editPinId) {
            ...
            promise.success(function(data) {
                ...
                $('#pin-form-description_2').val(editedPin.description_2);
                $('#pin-form-youtube').val(editedPin.youtube);
